    ...
    <div className="component container">
      <div className="projects">
        ...
        <div className="row row-cols-1 row-cols-lg-2 g-2 mt-3" data-aos-duration="2000">
          ...
          <div className="col">
            <ProjectCard img="/project-thumbnails/multiplex.png" title="Online Multiplex Ticket Booking System" desc="Crafted a standout web project surpassing typical booking websites.Unique features and modern design ensure a delightful user experience." techs={[["PHP", "info"], ["SQL", "success"], ["JavaScript", "danger"], ["Bootstrap", "secondary"], ["HTML", "primary"], ["CSS", "warning"]]} link="https://github.com/paju3125/My-Shows" />
          </div>
